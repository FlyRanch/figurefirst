...
class FigureFirstPatchTagEffect(inkex.Effect):
    """
    ...
    def __init__(self):
        ...
        try:
            inkex.etree.register_namespace(
    ...
    def effect(self):
        ...
        newElm = inkex.etree.Element(inkex.addNS("patchspec", "figurefirst"))
...
effect = FigureFirstPatchTagEffect()
effect.affect()
