...
def make_plot(template_filename, output_filename):
    ...
    colors = {"group1": "green", "group2": "blue", "group3": "orange"}
    ...
    functions = {"ax1": np.sin, "ax2": np.cos, "ax3": np.tan}

    notes = {
        "group1": "random data about green fish",
    ...
    for group in ["group1", "group2", "group3"]:
        for ax in ["ax1", "ax2", "ax3"]:
            ...
            figurefirst.mpl_functions.adjust_spines(
                mpl_axis,
                spines[ax],
