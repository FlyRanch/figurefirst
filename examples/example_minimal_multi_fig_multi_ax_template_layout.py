...
def method_1():
    ...
    layout = figurefirst.svg_to_axes.FigureLayout(
        "example_minimal_multi_fig_multi_ax_template_layout.svg", make_mplfigures=True
    )
    ...
    layout.append_figure_to_layer(
        layout.figures["figure1_copy"], "figure1_copy", cleartarget=True
    )

    # Write (save) the resulting svg
    layout.write_svg(
        "output_of_examples/example_minimal_multi_fig_multi_ax_template_layout.svg"
    )
