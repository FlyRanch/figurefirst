...
def method_1():
    ...
    layout = figurefirst.svg_to_axes.FigureLayout('example_minimal_multi_fig_multi_ax_layout.svg', make_mplfigures=True)
    ...
    layout.write_svg('output_of_examples/example_minimal_multi_fig_multi_ax_method1_layout.svg')
...
def __create_figure_1__():
    ...
    # Write (save) the resulting svg
    layout.write_svg('output_of_examples/example_minimal_multi_fig_multi_ax_method2_layout.svg')

def __create_figure_2__():
    # must run "create_figure_1" first! Note that layout grabs the svg created with "create_figure_1"
    layout = figurefirst.svg_to_axes.FigureLayout('output_of_examples/example_minimal_multi_fig_multi_ax_method2_layout.svg', make_mplfigures=True)
...
def method_3():
    ...
    # save output
    layout.write_svg('output_of_examples/example_minimal_multi_fig_multi_ax_method3_layout.svg')
