...
layout = figurefirst.FigureLayout('multi_figures_autogen_targetlayers.svg', autogenlayers=False )

layout.make_mplfigures()

name_to_color = {'figure1': 'blue',
                 'figure2': 'red',
                 }
...
layout = figurefirst.FigureLayout('multi_figures_autogen_targetlayers.svg', autogenlayers=True )
